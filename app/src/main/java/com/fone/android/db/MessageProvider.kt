...
import com.fone.android.util.chat.FoneLimitOffsetDataSource
        ...
        fun getMessages(conversationId: String, database: FoneDatabase) =
            object : DataSource.Factory<Int, MessageItem>() {
                override fun create(): DataSource<Int, MessageItem> {
                    ...
                    return object : FoneLimitOffsetDataSource<MessageItem>(database, statement, countStatement, false, "messages", "users", "snapshots", "assets", "stickers", "hyperlinks", "conversations") {
