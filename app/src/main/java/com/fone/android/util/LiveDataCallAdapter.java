 ...
 * @param <R>
 */
public class LiveDataCallAdapter<R> implements CallAdapter<R, LiveData<FoneResponse<R>>> {
    ...
    @Override
    public LiveData<FoneResponse<R>> adapt(@NonNull Call<R> call) {
        return new LiveData<FoneResponse<R>>() {
                ...
                if (started.compareAndSet(false, true)) {
                    call.enqueue(new Callback<R>() {
                        ...
                        public void onResponse(@NonNull Call<R> call, @NonNull Response<R> response) {
                            postValue(new FoneResponse<>(response));
                        }

                        @Override
                        public void onFailure(@NonNull Call<R> call, @NonNull Throwable throwable) {
                            postValue(new FoneResponse<>(throwable));
                        }
                    });
                }
            }
