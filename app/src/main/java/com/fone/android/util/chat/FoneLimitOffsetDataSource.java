package com.fone.android.util.chat;
...
public abstract class FoneLimitOffsetDataSource<T> extends PositionalDataSource<T> {
    ...
    protected FoneLimitOffsetDataSource(RoomDatabase db, SupportSQLiteQuery query,
    ...
    protected FoneLimitOffsetDataSource(RoomDatabase db, RoomSQLiteQuery query,
                                        RoomSQLiteQuery countQuery,
                                        boolean inTransaction, String... tables) {
        mDb = db;
        mSourceQuery = query;
