...
class FoneHeadersDecoration private constructor(
    private val mAdapter: FoneStickyRecyclerHeadersAdapter<*>,
    ...
    constructor(adapter: FoneStickyRecyclerHeadersAdapter<*>) : this(adapter,
        LinearLayoutOrientationProvider(), DimensionCalculator())

    private constructor(
        adapter: FoneStickyRecyclerHeadersAdapter<*>,
